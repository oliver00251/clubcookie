        ...
        <table class="table table-hover table-bordered" id="produtos-table">
            ...
            <tbody>
                ...
                <tr id="produto-{{ $produto->id }}">
                    ...
                    <td>
                        @if($produto->imagem)
                            <img src="{{ asset('storage/' . $produto->imagem) }}" class="produto-img" alt="{{ $produto->nome }}" style="width: 50px; height: 50px; object-fit: cover;">
                        @else
                            -
                        @endif
                    </td>
                    ...
                    <td><a href="{{ $produto->link }}" target="_blank" class="text-decoration-none">{{ $produto->link }}</a></td>
                    <td>{{ $produto->emoji ?? '-' }}</td>
                    <td>
                        <button class="btn btn-sm btn-warning" onclick="editarProduto({{ $produto->id }})" data-bs-toggle="modal" data-bs-target="#modalCadastro">Editar</button>
...
<div class="modal fade" id="modalCadastro" tabindex="-1" aria-labelledby="modalCadastroLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formProduto" method="POST" action="{{ route('produtos.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="emoji" id="emoji" maxlength="10">
                        </div>
                        <div class="col-md-3">
